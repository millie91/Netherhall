...
JTRT Responsive Tables is a plugin designed to help average wordrpess users create amazing responsive tables for their websites without having to deal with HTML or CSS. It is now easier than ever to create tables!
...
A special thank you to Joerg K. (@yogieanamcara) for helping me improve the plugin and for taking the time to translate this plugin into Dutch!
