...
/**
 * Provides methods to retrieve tweet output arguments.
 * 
 * @since       2.5.0
 */
class FetchTweets_Output_Tweet___Argument extends FetchTweets_Output_Tweet___Argument_Base {
    ...
    public function get() {
        return $this->uniteArrays( 
            $this->_aArguments,         // passed arguments for the API request
            $this->getDefaults()
        );            
    }
