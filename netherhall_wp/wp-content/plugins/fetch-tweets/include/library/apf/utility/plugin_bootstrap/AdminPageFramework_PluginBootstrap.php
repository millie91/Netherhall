...
abstract class FetchTweets_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('FetchTweets_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new FetchTweets_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
