...
abstract class FetchTweets_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'FetchTweets_AdminPageFramework_Form_', 'oPageLoadInfo' => 'FetchTweets_AdminPageFramework_PageLoadInfo_', 'oResource' => 'FetchTweets_AdminPageFramework_Resource_', 'oHelpPane' => 'FetchTweets_AdminPageFramework_HelpPane_', 'oLink' => 'FetchTweets_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'FetchTweets_AdminPageFramework_Debug', 'oUtil' => 'FetchTweets_AdminPageFramework_FrameworkUtility', 'oMsg' => 'FetchTweets_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(FetchTweets_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return FetchTweets_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class FetchTweets_AdminPageFramework_Factory_Model extends FetchTweets_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class FetchTweets_AdminPageFramework_Factory_View extends FetchTweets_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new FetchTweets_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class FetchTweets_AdminPageFramework_Factory_Controller extends FetchTweets_AdminPageFramework_Factory_View {
...
abstract class FetchTweets_AdminPageFramework_Factory extends FetchTweets_AdminPageFramework_Factory_Controller {
}
