...
abstract class FetchTweets_AdminPageFramework_Input_Base extends FetchTweets_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'fetch-tweets-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'fetch-tweets-input-label-string',),);
...
class FetchTweets_AdminPageFramework_Input_checkbox extends FetchTweets_AdminPageFramework_Input_Base {
