...
class FetchTweets_AdminPageFramework_Model__FormSubmission__Validator_Base extends FetchTweets_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class FetchTweets_AdminPageFramework_Model__FormSubmission__Validator extends FetchTweets_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__Link', 'FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__Import', 'FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__Export', 'FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
