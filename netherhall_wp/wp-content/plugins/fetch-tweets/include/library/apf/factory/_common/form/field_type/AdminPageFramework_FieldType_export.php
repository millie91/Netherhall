...
class FetchTweets_AdminPageFramework_FieldType_submit extends FetchTweets_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".fetch-tweets-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'fetch-tweets-input-label-container' . ' fetch-tweets-input-button-container' . ' fetch-tweets-input-container',);
    }
...
class FetchTweets_AdminPageFramework_FieldType_export extends FetchTweets_AdminPageFramework_FieldType_submit {
