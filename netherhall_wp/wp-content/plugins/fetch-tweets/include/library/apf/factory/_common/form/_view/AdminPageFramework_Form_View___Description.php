...
class FetchTweets_AdminPageFramework_Form_View___Description extends FetchTweets_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'fetch-tweets-form-element-description';
