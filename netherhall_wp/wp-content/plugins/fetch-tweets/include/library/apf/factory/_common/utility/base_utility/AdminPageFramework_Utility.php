...
abstract class FetchTweets_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        FetchTweets_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return FetchTweets_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        FetchTweets_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return FetchTweets_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        FetchTweets_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        FetchTweets_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        FetchTweets_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'FetchTweets_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
...
abstract class FetchTweets_AdminPageFramework_Utility_VariableType extends FetchTweets_AdminPageFramework_Utility_Deprecated {
...
abstract class FetchTweets_AdminPageFramework_Utility_String extends FetchTweets_AdminPageFramework_Utility_VariableType {
...
abstract class FetchTweets_AdminPageFramework_Utility_Array extends FetchTweets_AdminPageFramework_Utility_String {
...
abstract class FetchTweets_AdminPageFramework_Utility_ArrayGetter extends FetchTweets_AdminPageFramework_Utility_Array {
...
abstract class FetchTweets_AdminPageFramework_Utility_ArraySetter extends FetchTweets_AdminPageFramework_Utility_ArrayGetter {
...
abstract class FetchTweets_AdminPageFramework_Utility_Path extends FetchTweets_AdminPageFramework_Utility_ArraySetter {
...
abstract class FetchTweets_AdminPageFramework_Utility_URL extends FetchTweets_AdminPageFramework_Utility_Path {
...
abstract class FetchTweets_AdminPageFramework_Utility_File extends FetchTweets_AdminPageFramework_Utility_URL {
...
abstract class FetchTweets_AdminPageFramework_Utility_SystemInformation extends FetchTweets_AdminPageFramework_Utility_File {
...
abstract class FetchTweets_AdminPageFramework_Utility_HTMLAttribute extends FetchTweets_AdminPageFramework_Utility_SystemInformation {
...
class FetchTweets_AdminPageFramework_Utility extends FetchTweets_AdminPageFramework_Utility_HTMLAttribute {
