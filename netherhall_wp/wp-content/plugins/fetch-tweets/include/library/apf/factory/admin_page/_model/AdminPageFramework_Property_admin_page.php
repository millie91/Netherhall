...
class FetchTweets_AdminPageFramework_Property_admin_page extends FetchTweets_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'fetch-tweets') {
        ...
        $GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aFetchTweets_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
