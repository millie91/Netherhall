...
abstract class FetchTweets_AdminPageFramework_Property_Base extends FetchTweets_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'fetch-tweets' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['aFetchTweets_AdminPageFramework'])) {
            $GLOBALS['aFetchTweets_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => FetchTweets_AdminPageFramework_Registry::NAME, 'sURI' => FetchTweets_AdminPageFramework_Registry::URI, 'sScriptName' => FetchTweets_AdminPageFramework_Registry::NAME, 'sLibraryName' => FetchTweets_AdminPageFramework_Registry::NAME, 'sLibraryURI' => FetchTweets_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => FetchTweets_AdminPageFramework_Registry::getVersion(), 'sDescription' => FetchTweets_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => FetchTweets_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => FetchTweets_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => FetchTweets_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => FetchTweets_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
