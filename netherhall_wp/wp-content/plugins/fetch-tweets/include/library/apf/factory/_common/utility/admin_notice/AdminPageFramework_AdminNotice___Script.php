...
class FetchTweets_AdminPageFramework_AdminNotice___Script extends FetchTweets_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.fetch-tweets-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='fetch-tweets-admin-notice-animation-container'></div>" );
