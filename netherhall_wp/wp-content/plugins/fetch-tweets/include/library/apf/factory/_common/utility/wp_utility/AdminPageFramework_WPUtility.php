...
class FetchTweets_AdminPageFramework_WPUtility_URL extends FetchTweets_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(FetchTweets_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(FetchTweets_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = FetchTweets_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class FetchTweets_AdminPageFramework_WPUtility_HTML extends FetchTweets_AdminPageFramework_WPUtility_URL {
...
class FetchTweets_AdminPageFramework_WPUtility_Page extends FetchTweets_AdminPageFramework_WPUtility_HTML {
...
class FetchTweets_AdminPageFramework_WPUtility_File extends FetchTweets_AdminPageFramework_WPUtility_Hook {
...
class FetchTweets_AdminPageFramework_WPUtility_Option extends FetchTweets_AdminPageFramework_WPUtility_File {
...
class FetchTweets_AdminPageFramework_WPUtility_Meta extends FetchTweets_AdminPageFramework_WPUtility_Option {
...
class FetchTweets_AdminPageFramework_WPUtility_SiteInformation extends FetchTweets_AdminPageFramework_WPUtility_Meta {
...
class FetchTweets_AdminPageFramework_WPUtility_SystemInformation extends FetchTweets_AdminPageFramework_WPUtility_SiteInformation {
...
class FetchTweets_AdminPageFramework_WPUtility extends FetchTweets_AdminPageFramework_WPUtility_SystemInformation {
