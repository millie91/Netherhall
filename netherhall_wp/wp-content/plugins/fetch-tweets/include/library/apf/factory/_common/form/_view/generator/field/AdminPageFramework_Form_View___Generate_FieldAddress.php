...
abstract class FetchTweets_AdminPageFramework_Form_View___Generate_Field_Base extends FetchTweets_AdminPageFramework_Form_View___Generate_Section_Base {
...
class FetchTweets_AdminPageFramework_Form_View___Generate_FieldName extends FetchTweets_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class FetchTweets_AdminPageFramework_Form_View___Generate_FlatFieldName extends FetchTweets_AdminPageFramework_Form_View___Generate_FieldName {
    public function get() {
...
class FetchTweets_AdminPageFramework_Form_View___Generate_FieldAddress extends FetchTweets_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public function get() {
