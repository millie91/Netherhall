...
class FetchTweets_AdminPageFramework_Form_View___Script_SectionTab extends FetchTweets_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.fetch-tweets-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='fetch-tweets-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
