...
abstract class FetchTweets_AdminPageFramework_Model__FormSubmission_Base extends FetchTweets_AdminPageFramework_FrameworkUtility {
...
class FetchTweets_AdminPageFramework_Model__FormSubmission extends FetchTweets_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new FetchTweets_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new FetchTweets_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
