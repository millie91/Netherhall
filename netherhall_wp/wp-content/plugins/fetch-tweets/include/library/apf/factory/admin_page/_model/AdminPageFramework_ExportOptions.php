...
abstract class FetchTweets_AdminPageFramework_CustomSubmitFields extends FetchTweets_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class FetchTweets_AdminPageFramework_ExportOptions extends FetchTweets_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo FetchTweets_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
