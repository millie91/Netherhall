...
class FetchTweets_AdminPageFramework_Debug_Base extends FetchTweets_AdminPageFramework_FrameworkUtility {
...
class FetchTweets_AdminPageFramework_Debug_Log extends FetchTweets_AdminPageFramework_Debug_Base {
...
class FetchTweets_AdminPageFramework_Debug extends FetchTweets_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('FetchTweets_AdminPageFramework_Debug::' . __FUNCTION__, 'FetchTweets_AdminPageFramework_Debug::dump()');
        FetchTweets_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('FetchTweets_AdminPageFramework_Debug::' . __FUNCTION__, 'FetchTweets_AdminPageFramework_Debug::get()');
        return FetchTweets_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('FetchTweets_AdminPageFramework_Debug::' . __FUNCTION__, 'FetchTweets_AdminPageFramework_Debug::log()');
        FetchTweets_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('FetchTweets_AdminPageFramework_Debug::' . __FUNCTION__);
