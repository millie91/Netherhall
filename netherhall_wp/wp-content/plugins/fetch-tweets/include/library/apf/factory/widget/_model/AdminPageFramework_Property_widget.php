...
class FetchTweets_AdminPageFramework_Property_widget extends FetchTweets_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'fetch-tweets', $sStructureType) {
