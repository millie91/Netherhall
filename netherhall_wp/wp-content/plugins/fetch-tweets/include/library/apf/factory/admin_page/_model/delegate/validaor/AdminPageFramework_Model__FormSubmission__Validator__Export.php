...
class FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__Import extends FetchTweets_AdminPageFramework_Model__FormSubmission__Validator_Base {
...
class FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__Export extends FetchTweets_AdminPageFramework_Model__FormSubmission__Validator__Import {
    public $sActionHookPrefix = 'try_validation_after_';
    ...
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new FetchTweets_AdminPageFramework_ExportOptions($_POST['__export'], $this->oFactory->oProp->sClassName);
