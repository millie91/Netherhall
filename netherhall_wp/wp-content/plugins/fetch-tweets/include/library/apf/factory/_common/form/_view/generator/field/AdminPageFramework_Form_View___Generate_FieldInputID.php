...
class FetchTweets_AdminPageFramework_Form_View___Generate_FieldTagID extends FetchTweets_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class FetchTweets_AdminPageFramework_Form_View___Generate_FieldInputID extends FetchTweets_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
