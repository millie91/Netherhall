...
class FetchTweets_AdminPageFramework_Form_View___DebugInfo extends FetchTweets_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='fetch-tweets-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
