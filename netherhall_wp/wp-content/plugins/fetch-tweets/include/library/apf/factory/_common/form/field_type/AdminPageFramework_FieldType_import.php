...
class FetchTweets_AdminPageFramework_FieldType_import extends FetchTweets_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".fetch-tweets-field-import input {margin-right: 0.5em;}.fetch-tweets-field-import label,.form-table td fieldset.fetch-tweets-fieldset .fetch-tweets-field-import label { display: inline; }";
    }
