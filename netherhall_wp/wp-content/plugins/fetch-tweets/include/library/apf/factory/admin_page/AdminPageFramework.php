...
abstract class FetchTweets_AdminPageFramework_Router extends FetchTweets_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'fetch-tweets') {
        $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'FetchTweets_AdminPageFramework_Property_' . $this->_sStructureType;
...
abstract class FetchTweets_AdminPageFramework_Model_Form extends FetchTweets_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'fetch-tweets') {
        ...
        new FetchTweets_AdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new FetchTweets_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class FetchTweets_AdminPageFramework_View_Form extends FetchTweets_AdminPageFramework_Model_Form {
...
abstract class FetchTweets_AdminPageFramework_Controller_Form extends FetchTweets_AdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return FetchTweets_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class FetchTweets_AdminPageFramework_Model_Page extends FetchTweets_AdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs() {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new FetchTweets_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
...
abstract class FetchTweets_AdminPageFramework_View_Page extends FetchTweets_AdminPageFramework_Model_Page {
    public function _replyToEnablePageMetaBoxes() {
        new FetchTweets_AdminPageFramework_View__PageMetaboxEnabler($this);
    }
    public function _replyToEnqueuePageAssets() {
        new FetchTweets_AdminPageFramework_View__Resource($this);
    }
    ...
    protected function _renderPage($sPageSlug, $sTabSlug = null) {
        $_oPageRenderer = new FetchTweets_AdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
        $_oPageRenderer->render();
    }
}
abstract class FetchTweets_AdminPageFramework_Controller_Page extends FetchTweets_AdminPageFramework_View_Page {
...
abstract class FetchTweets_AdminPageFramework_Model_Menu extends FetchTweets_AdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'fetch-tweets') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
        }
        new FetchTweets_AdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class FetchTweets_AdminPageFramework_View_Menu extends FetchTweets_AdminPageFramework_Model_Menu {
}
abstract class FetchTweets_AdminPageFramework_Controller_Menu extends FetchTweets_AdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new FetchTweets_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new FetchTweets_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
        $_aSubMenuPage = $_oFormatter->get();
        $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
    }
}
abstract class FetchTweets_AdminPageFramework_Model extends FetchTweets_AdminPageFramework_Controller_Menu {
}
abstract class FetchTweets_AdminPageFramework_View extends FetchTweets_AdminPageFramework_Model {
    public function content($sContent) {
        return $sContent;
    }
}
abstract class FetchTweets_AdminPageFramework_Controller extends FetchTweets_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new FetchTweets_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, '_isInThePage'),));
    }
...
abstract class FetchTweets_AdminPageFramework extends FetchTweets_AdminPageFramework_Controller {
    protected $_sStructureType = 'admin_page';
    public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'fetch-tweets') {
    ...
    private function _getCallerPath($sCallerPath) {
        ...
        $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? FetchTweets_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
