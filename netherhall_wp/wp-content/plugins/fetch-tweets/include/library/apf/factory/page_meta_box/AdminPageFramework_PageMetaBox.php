...
abstract class FetchTweets_AdminPageFramework_PageMetaBox_Router extends FetchTweets_AdminPageFramework_MetaBox_View {
...
abstract class FetchTweets_AdminPageFramework_PageMetaBox_Model extends FetchTweets_AdminPageFramework_PageMetaBox_Router {
...
abstract class FetchTweets_AdminPageFramework_PageMetaBox_View extends FetchTweets_AdminPageFramework_PageMetaBox_Model {
}
abstract class FetchTweets_AdminPageFramework_PageMetaBox_Controller extends FetchTweets_AdminPageFramework_PageMetaBox_View {
...
abstract class FetchTweets_AdminPageFramework_PageMetaBox extends FetchTweets_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'fetch-tweets') {
