...
abstract class FetchTweets_AdminPageFramework_PageLoadInfo_Base extends FetchTweets_AdminPageFramework_FrameworkUtility {
    public $oProp;
    public $oMsg;
