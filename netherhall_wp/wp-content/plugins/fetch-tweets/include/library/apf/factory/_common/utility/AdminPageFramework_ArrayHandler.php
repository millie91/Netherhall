...
class FetchTweets_AdminPageFramework_FrameworkUtility extends FetchTweets_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = FetchTweets_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return FetchTweets_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class FetchTweets_AdminPageFramework_ArrayHandler extends FetchTweets_AdminPageFramework_FrameworkUtility {
    public $aData = array();
