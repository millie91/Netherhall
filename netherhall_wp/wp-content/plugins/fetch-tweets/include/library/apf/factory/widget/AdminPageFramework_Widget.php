...
abstract class FetchTweets_AdminPageFramework_Widget_Router extends FetchTweets_AdminPageFramework_Factory {
...
abstract class FetchTweets_AdminPageFramework_Widget_Model extends FetchTweets_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new FetchTweets_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class FetchTweets_AdminPageFramework_Widget_View extends FetchTweets_AdminPageFramework_Widget_Model {
...
abstract class FetchTweets_AdminPageFramework_Widget_Controller extends FetchTweets_AdminPageFramework_Widget_View {
...
abstract class FetchTweets_AdminPageFramework_Widget extends FetchTweets_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'fetch-tweets') {
