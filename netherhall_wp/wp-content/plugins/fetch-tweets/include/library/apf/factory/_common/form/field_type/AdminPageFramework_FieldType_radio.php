...
class FetchTweets_AdminPageFramework_FieldType_radio extends FetchTweets_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".fetch-tweets-field input[type='radio'] {margin-right: 0.5em;} .fetch-tweets-field-radio .fetch-tweets-input-label-container {padding-right: 1em;} .fetch-tweets-field-radio .fetch-tweets-input-container {display: inline;} .fetch-tweets-field-radio .fetch-tweets-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.fetch-tweets-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
