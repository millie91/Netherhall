...
class FetchTweets_AdminPageFramework_Form_Model___SetFieldResources extends FetchTweets_AdminPageFramework_Form_Base {
    ...
    private function _setCommon() {
        ...
        self::$_bCalled = true;
        new FetchTweets_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->_setCommonFormInternalCSSRules();
    }
    private function _setCommonFormInternalCSSRules() {
        $_aClassNames = array('FetchTweets_AdminPageFramework_Form_View___CSS_Form', 'FetchTweets_AdminPageFramework_Form_View___CSS_Field', 'FetchTweets_AdminPageFramework_Form_View___CSS_Section', 'FetchTweets_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'FetchTweets_AdminPageFramework_Form_View___CSS_FieldError', 'FetchTweets_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('FetchTweets_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function _setFieldResources(array $aFieldset) {
        ...
        new FetchTweets_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new FetchTweets_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
