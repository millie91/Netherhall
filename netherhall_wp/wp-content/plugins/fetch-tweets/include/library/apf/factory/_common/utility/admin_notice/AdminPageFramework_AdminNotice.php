...
class FetchTweets_AdminPageFramework_AdminNotice extends FetchTweets_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'fetch-tweets-settings-notice-message', 'fetch-tweets-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new FetchTweets_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
