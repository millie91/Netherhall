 ...
 *      'field_id'      => 'date_range',
 *      'title'         => __( 'Date Range', 'fetch-tweets-field-type-pack' ),
 *      'type'          => 'date_range',
 *  ),     
 *  array( // Single date_range picker
 *      'field_id'      => 'date_range_repeatable',
 *      'title'         => __( 'Repeatable Date Range', 'fetch-tweets-field-type-pack' ),
 *      'type'          => 'date_range',
 *      'repeatable'    => true,
 *      'sortable'      => true,
 *      'options'       => array(
 ...
 * @version     1.0.1
 */
class DateRangeCustomFieldType extends FetchTweets_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    protected function getStyles() {
        ...
        return "/* Date Picker */
            ...
            .form-table td .fetch-tweets-field-date_range label {
                display: inline-block;
                width:    auto;
                padding-right: 1em;
            }
            .form-table td .fetch-tweets-field-date_range .fetch-tweets-repeatable-field-buttons {
                margin-bottom: 0;
            }
            " . PHP_EOL;
    }    
