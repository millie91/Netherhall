 ...
 *      'field_id'      => 'time',
 *      'type'          => 'time',
 *      'title'         => __( 'Time', 'fetch-tweets-field-type-pack' ),
 *      'time_format'   => 'H:mm', // H:mm is the default format.
 *  ),
 *  array( // Repeatable time picker fields
 *      'field_id'      => 'time_repeatable',
 *      'type'          => 'time',
 *      'title'         => __( 'Repeatable Time Fields', 'fetch-tweets-field-type-pack' ),
 *      'repeatable'    => true,
 *      'options'       => array(     
 *          'hourGrid'      => 4,
 *          'minuteGrid'    => 10,
 *          'timeFormat'    => 'hh:mm tt',
 *      ),
 *      'description'   => __( 'The grid option is set.', 'fetch-tweets-field-type-pack' ), 
 *  ),
 *  array( // Sortable 
 ...
 *          'hourMax' => 16,
 *      ),
 *      'description'   => __( 'The maximum and minimum hours are set.', 'fetch-tweets-field-type-pack' ), 
 ...
 * @version     1.0.1
 */
class TimeCustomFieldType extends FetchTweets_AdminPageFramework_FieldType {
