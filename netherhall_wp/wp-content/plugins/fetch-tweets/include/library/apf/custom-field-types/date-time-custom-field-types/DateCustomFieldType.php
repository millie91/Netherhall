...
if ( ! class_exists( 'FetchTweets_DateCustomFieldType' ) ) :
 ...
 *      'type'          => 'date',
 *      'title'         => __( 'Repeatable', 'fetch-tweets' ),
 *      'repeatable'    =>    true,
 ...
 *      'type'          => 'date',
 *      'title'         => __( 'Sortable', 'fetch-tweets' ),
 *      'sortable'      => true,
 *      'options'       => '{
 ...
 * @version     1.0.1
 */
class FetchTweets_DateCustomFieldType extends FetchTweets_AdminPageFramework_FieldType {
