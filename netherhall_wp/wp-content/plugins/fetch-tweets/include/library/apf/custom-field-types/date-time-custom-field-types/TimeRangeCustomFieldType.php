 ...
 *      'field_id'      => 'time_range',
 *      'title'         => __( 'Time Range', 'fetch-tweets-field-type-pack' ),
 *      'type'          => 'time_range',
 *  ),    
 *  array( // Sortable and repeatable time_range picker
 *      'field_id'      => 'time_range_repeatable',
 *      'title'         => __( 'Repeatable Time Range', 'fetch-tweets-field-type-pack' ),
 *      'type'          => 'time_range',
 ...
 * @version     1.0.1
 */
class TimeRangeCustomFieldType extends FetchTweets_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    protected function getStyles() {
        ...
        return "/* Date Picker */
            ...
            .form-table td .fetch-tweets-field-time_range label {
                display: inline-block;
                width:    auto;
                padding-right: 1em;
            }
            .form-table td .fetch-tweets-field-time_range .fetch-tweets-repeatable-field-buttons {
                margin-bottom: 0;
            }
            " . PHP_EOL;
    }    
