...
if( !function_exists( 'business_press_admin_notice' ) )
{
	function business_press_admin_notice() {
		...
		printf( __( 'Thank you for activating Business Press theme. Let start form <a target="_blank" href="%1$s">Online Documentation</a> | <a target="_blank" href="%2$s">Visit Demo</a> | <a href="%3$s">Hide This Notice</a>', 'business-press' ), 'http://ewptheme.com/business-press-free-wordpress-theme-documentation/', 'http://business-press.ewptheme.com/', '?business_press_notics_ignore=0' );
